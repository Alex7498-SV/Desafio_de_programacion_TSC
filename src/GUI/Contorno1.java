 ...
 * @author alex
 */
public class Contorno1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botonReturn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 370, -1, -1));

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/img/final.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Contorno1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
