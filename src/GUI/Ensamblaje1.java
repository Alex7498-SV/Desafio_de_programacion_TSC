 ...
 * @author alex
 */
public class Ensamblaje1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botonReturn, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 390, -1, -1));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/img/ensamblaje1.gif"))); // NOI18N
        getContentPane().add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, 390));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ensamblaje1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
