 ...
 * @author alex
 */
public class Step61 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(botonMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/MEF/S61.png"))); // NOI18N
    ...
    private void botonBackMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonBackMousePressed
        System.out.println("Regresando al paso 6");
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Step61.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
